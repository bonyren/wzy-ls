...
<form>
    <table class="table-form">
        ...
        <tr id="adminRoleRow">
            ...
            <td class="field-input">
                <select id="adminRoleCombobox" class="easyui-combobox" name="infos[role_id]" data-options="required:true,editable:true,limitToList:true,panelHeight:'auto',width:200">
