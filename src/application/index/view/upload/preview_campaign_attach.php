...
<div class="preview-container">
    <?php if($preview_type == 'office') : ?>
        <div class="loading">
            <div>
                <img src="__STATIC__/img/loading.gif">
                <p>Loading..</p>
            </div>
        </div>
        <iframe class="preview-attach" id="attach-preview-office" width="100%" height="100%" frameborder="0" src="<?=$preview_src?>"></iframe>
    <?php elseif($preview_type == 'image') : ?>
        <div class="preview-attach" id="attach-preview-image" style="height: 100%;">
            <img src="<?=$url?>" border="0"  height="500px" >
            <div style="position: absolute;z-index:10;right: 50px;top: 50px">
                <a href="javascript:void(0)" class="previewImageM btn btn-outline-light fa fa-search-minus"></a>
                <a href="javascript:void(0)" class="previewImageP btn btn-outline-light fa fa-search-plus"></a>
            </div>
        </div>
    <?php elseif($preview_type == 'pdf') : ?>
        <div class="preview-attach" id="attach-preview-pdf" style="height: 100%;"></div>
    <?php else : ?>
