<div class="daohe-panel daohe-panel-default" style="border-color:#fff;">
    <div class="daohe-panel-header clearfix">
        <div class="pull-left">
        <a href="#" class="easyui-linkbutton" data-options="iconCls:'fa fa-cloud-upload',onClick:function(){
            ...
            $.app.method.upload(url, function (obj) {
                ...
                $.each(obj.data,function(i,v){
                    html += '<div id="attach_file_{$uniqid}_' + v.attachment_id + '" class="attach-box-light">' +
                        '<div class="text-center mt-5"><a title="' + v.name + '" href="javascript:void(0)" onclick="QT.filePreview('+v.attachment_id+')">'+
                        v.name + '</a></div>' +
                        '<div class="text-center mt-5 attach-buttons">' +
