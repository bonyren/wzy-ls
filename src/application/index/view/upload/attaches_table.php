<div class="daohe-panel daohe-panel-default" style="border-color:#fff;">
    ...
    <div class="daohe-panel-body">
        <table class="daohe-table daohe-table-border daohe-table-bg mt-5 mb-5">
            <thead>
                <tr>
                    <th>文件名</th>
                    <!--
            ...
            $.app.method.upload(url, function (obj) {
                ...
                $.each(obj.data,function(i,v){
                    html += '<tr id="attach_file_{$uniqid}_' + v.attachment_id + '">' +
                        '<td class="text-center mt-5"><a title="' + v.name + '" href="javascript:void(0)" onclick="QT.filePreview('+v.attachment_id+')">'+
                        v.name + '</a></td>' +
