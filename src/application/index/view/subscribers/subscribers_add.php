<form id="subscribersAddForm" style="height: 100%;">
    <table class="table-form mb-1">
        <tr>
            <td class="field-label" style="width:30%;">邮箱:</td>
            <td class="field-input"><input class="easyui-textbox" name="email" data-options="required:true,width:'100%',
            validType:['length[1,128]', 'email', 'remote[\'{$urlHrefs.checkSubscriber}\', \'email\']']" /></td>
        </tr>
        <tr>
            <td class="field-label">姓名:</td>
            <td class="field-input"><input class="easyui-textbox" name="name" data-options="width:'100%',
    ...
    <div class="easyui-tabs" data-options="fit:true,border:false">
        ...
        <div title="所属集合" data-options="iconCls:'fa fa-list', cache:true">
    ...
    var addByDialogModule={
        init:function(){
            ...
            for(var i=0; i<rows.length; i++){
                ...
                if(-1 != $.inArray(parseInt(listId), defaultCheckedLists)){
                    $("#listsDatalist").datalist('checkRow', i);
                }
            }
        },
        serializeFormString:function(){
            var postStr = $("#subscribersAddForm").serialize();
