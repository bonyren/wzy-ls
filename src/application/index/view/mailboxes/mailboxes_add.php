...
<form>
    <table class="table-form">
        <tr>
            <td class="field-label" style="width:40%;">标题:</td>
            <td class="field-input"><input class="easyui-textbox" name="infos[title]" data-options="required:true,width:'100%',validType:['length[1,100]']" /></td>
        </tr>
        <!----------------------------------------------------------------------------------------------------------------->
        <tr><td colspan="2"></td></tr>
        <tr>
            <td class="field-label">发送姓名:</td>
            <td class="field-input"><input class="easyui-textbox" name="infos[from_name]" data-options="required:true,width:'100%',validType:['length[1,100]']" /></td>
        </tr>
        <tr>
            <td class="field-label">发送邮箱:</td>
            <td class="field-input"><input class="easyui-textbox" name="infos[from_email]" data-options="required:true,width:'100%',validType:['length[1,100]', 'email']" /></td>
        </tr>
        <!----------------------------------------------------------------------------------------------------------------->
        <tr><td colspan="2"></td></tr>
        <tr>
            <td class="field-label">发送服务器主机(SMTP):</td>
            <td class="field-input"><input class="easyui-textbox" id="smtp_host" name="infos[smtp_host]" data-options="required:true,width:'100%',validType:{length:[1,100]}" /></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="field-input"><input class="easyui-textbox" id="bounce_host" name="infos[bounce_host]" data-options="required:true,width:'100%',validType:{length:[1,100]}" /></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="field-input"><input class="easyui-textbox" id="account"  name="infos[account]" data-options="required:true,width:'100%',validType:{length:[1,100]}" /></td>
        </tr>
        <tr>
            <td class="field-label">密码:</td>
            <td class="field-input"><input class="easyui-textbox" id="password"  name="infos[password]" data-options="required:true,width:'100%',validType:{length:[1,100]}" /></td>
        </tr>
    </table>
</form>
<div class="text-center mt-1">
    <a href="#" class="easyui-linkbutton" data-options="onClick:function(){ addMailboxesModule.testOutgoingServer(); },iconCls:'fa fa-flask'">测试发送服务器</a>
    <a href="#" class="easyui-linkbutton" data-options="onClick:function(){ addMailboxesModule.testIncomingServer(); },iconCls:'fa fa-flask'">测试接收服务器</a>
</div>
<script type="text/javascript">
    var addMailboxesModule = {
        testOutgoingServer:function(){
            ...
            if(!smtpHost || !smtpPort){
                $.app.method.alertError('提示', '请录入完整数据');
                return;
            }
