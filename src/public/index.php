...
//for security reason, move it from public
define('IMPORT_DIR', APP_PATH . '..' .DIRECTORY_SEPARATOR . 'temp' . DIRECTORY_SEPARATOR . IMPORT_FOLDER);
