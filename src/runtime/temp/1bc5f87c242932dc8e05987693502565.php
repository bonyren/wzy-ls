<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:105:"D:\MY-workspace\wzyer-list\output\web\public\..\application\index\view\subscribers\subscribers_search.php";i:1721966870;}*/ ?>
<?php
...
<table id="subscribersSearchDatagrid" class="easyui-datagrid" data-options="striped:true,
    ...
    checkOnSelect:false,
    selectOnCheck:false,
    url:'<?php echo $urlHrefs['subscribersSearch']; ?>',
    method:'post',
...
<script>
    var subscribersSearchModule = {
        ...
        add:function(){
            var that = this;
            var href = '<?php echo $urlHrefs['subscribersSearchAdd']; ?>';
            $(that.dialog).dialog({
                title: '新增订阅者',
        ...
        edit:function(subscriberId, title){
            var that = this;
            var href = '<?php echo $urlHrefs['subscribersSearchEdit']; ?>';
        ...
        delete:function(subscriberId, title){
            var that = this;
            var href = '<?php echo $urlHrefs['subscribersSearchDelete']; ?>';
            href = GLOBAL.func.addUrlParam(href, 'subscriberId', subscriberId);
        ...
        whitelist:function(subscriberId, title){
            var that = this;
            var href = '<?php echo $urlHrefs['subscribersWhitelist']; ?>';
            href = GLOBAL.func.addUrlParam(href, 'subscriberId', subscriberId);
        ...
        blacklist:function(subscriberId, title){
            var that = this;
            var href = '<?php echo $urlHrefs['subscribersBlacklist']; ?>';
            href = GLOBAL.func.addUrlParam(href, 'subscriberId', subscriberId);
        ...
        downloadCSV:function(element){
            var that = this;
            var href = '<?php echo $urlHrefs['subscribersAllExport']; ?>';
            $(that.dialog).dialog({
                title: '导出订阅者',
        ...
        import:function(element){
            var that = this;
            var href = '<?php echo $urlHrefs['subscribersAllImport']; ?>';
            $(that.dialog).dialog({
                title: '导入订阅者',
        ...
        deleteChecked:function(element){
            ...
            var href = '<?php echo $urlHrefs['subscribersDeleteChecked']; ?>';
