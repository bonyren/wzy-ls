<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:86:"D:\MY-workspace\wzyer-list\output\web\public\..\application\index\view\lists\lists.php";i:1721966870;}*/ ?>
<?php
...
<script>
    var listsModule = {
        ...
        active:function(listId, isActive, title){
            var that = this;
            var href = '<?php echo $urlHrefs['updateActive']; ?>';
        ...
        add:function(){
            var that = this;
            var href = '<?php echo $urlHrefs['add']; ?>';
            $(that.dialog).dialog({
                title: '新增集合',
        ...
        edit:function(listId, title){
            var that = this;
            var href = '<?php echo $urlHrefs['edit']; ?>';
            href = GLOBAL.func.addUrlParam(href, 'listId', listId);
            $(that.dialog).dialog({
                title: '修改集合 - ' + title,
        ...
        delete:function(listId, title){
            var that = this;
            var href = '<?php echo $urlHrefs['delete']; ?>';
            href = GLOBAL.func.addUrlParam(href, 'listId', listId);
        ...
        importMembers:function(listId, name){
            var that = this;
            var href = '<?php echo $urlHrefs['subscribersImportList']; ?>';
            href = GLOBAL.func.addUrlParam(href, 'listId', listId);
            $(that.dialog).dialog({
                title: '导入订阅者到集合' + name,
