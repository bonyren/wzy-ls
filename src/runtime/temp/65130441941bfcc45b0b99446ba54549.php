<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:85:"D:\MY-workspace\wzyer-list\output\web\public\..\application\index\view\lists\tree.php";i:1721966870;}*/ ?>
<?php
...
<div id="listsTree" class="easyui-tree"
     data-options="url:'<?php echo $urlHrefs['tree']; ?>',
        animate:true,
        lines:true,
        border:false,
        queryParams:{
...
var listsTreeModule = {
    ...
    upDown:function(direction){
        ...
        var href = '<?php echo $urlHrefs['updateOrder']; ?>';
